...
const FAQS = [
    {
        id: "faq-free",
        type: "faq",
        title: "Are the templates completely free?",
        excerpt: "All templates are free for personal or commercial use.",
        page: "faq",
        tags: ["free", "licence", "templates"],
    },
    {
        id: "faq-client",
        type: "faq",
        title: "Can I use the templates for client projects?",
        excerpt: "Yes, you can use templates in unlimited client work.",
        page: "faq",
        tags: ["client", "licence", "usage"],
    },
    {
        id: "faq-download",
        type: "faq",
        title: "What is included in the download?",
        excerpt: "Source code, assets, and setup documentation are included.",
        page: "faq",
        tags: ["download", "source code", "readme"],
    },
    {
        id: "faq-custom",
        type: "faq",
        title: "Do you offer customisation services?",
        excerpt: "Yes. Custom modifications and bespoke builds are available.",
        page: "faq",
...
const LEGAL = [
    {
        id: "legal-terms",
        type: "legal",
        title: "Template Usage Rights",
        excerpt: "Templates are MIT licensed and free to use with attribution optional.",
        page: "terms",
        tags: ["licence", "mit", "terms"],
    },
    {
        id: "legal-privacy",
        type: "legal",
        title: "Data Usage",
        excerpt: "Contact form data is used only to respond to inquiries.",
        page: "privacy",
        tags: ["privacy", "data"],
    },
];
...
export const SITE_INDEX = [...PAGES, ...SERVICES, ...FAQS, ...LEGAL, ...TEMPLATE_ITEMS];
