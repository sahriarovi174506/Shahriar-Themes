...
export function AboutPage({ setPage }) {
  ...
  return (
    <>
      <div className="page-header about-hero" data-parallax="16">
      ...
      <section className="about-story-section">
        <div className="container">
          <div className="about-story-wrap" data-aos="fade-up" data-aos-duration="900" data-aos-delay="80">
            <div className="about-story-content" data-aos="fade-left" data-aos-duration="900" data-aos-delay="140">
              ...
              <div style={{ color:"var(--text-2)", fontSize:"1.6rem", lineHeight:"1.8" }} className="fade-right delay-2 animated about-story-copy">
