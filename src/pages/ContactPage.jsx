    ...
    <>
      <div className="page-header" data-parallax="16">
        <div className="container" data-aos="fade-up" data-aos-duration="850">
          ...
          <p className="fade-up delay-1 animated">Tell me about your project goals. I'll analyze your requirements and get back to you with a free estimate within 24 hours.</p>
        </div>
      </div>
      <section style={{ paddingTop:"0" }}>
        <div className="container">
          <div className="split-2 split-2--contact" data-aos="fade-up" data-aos-duration="900" data-aos-delay="80">
            <div data-aos="fade-right" data-aos-duration="850" data-aos-delay="110">
              ...
              <p style={{ color:"var(--text-2)", fontSize:"1.6rem", lineHeight:"1.7", marginBottom:"4rem" }} className="fade-left delay-2 animated">Stop losing visitors to a slow, generic site. Whether you need a high-converting landing page or a full custom business platform, I'm here to help you grow.</p>
              <div style={{ display:"flex", flexDirection:"column", gap:"1.6rem" }}>
                {contactInfo.map((c, i) => (
                  <div
                    key={c.title}
                    className={`contact-info-item fade-left delay-${i+2} animated`}
                    data-aos="fade-right"
                    data-aos-duration="800"
                    data-aos-delay={130 + i * 70}
                  >
            ...
            <div className="fade-right animated" data-parallax="10" data-aos="fade-left" data-aos-duration="900" data-aos-delay="140">
              ...
              {status === "success" && (
                <div className="form-success">
                  <div style={{ fontSize:"3rem", marginBottom:"1.6rem" }}><Icon name="check" /></div>
                  ...
                  <button className="btn btn-primary" style={{ marginTop:"2.4rem" }} onClick={() => setStatus("idle")}>Send Another <Icon name="arrow" /></button>
                </div>
              )}
              {(status === "idle" || status === "loading") && (
                <form onSubmit={submit} className="card" style={{ padding:"3.6rem" }}>
